/*
 * This program reads the distance from single ping sensor
...
void setup() {
    Serial.begin(9600);
    mysensor.attach(8);//Trigger pin , Echo pin
}

void loop() {
    reading=mysensor.distanceInInch();
    Serial.print("Sensor Reading :");Serial.print(reading);Serial.println(" Inches");
    delay(1000);
}
